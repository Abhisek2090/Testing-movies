package com.embibe.tmdb.movies.data.remote;
...
import com.embibe.tmdb.movies.data.remote.api.ApiResponse;
import com.embibe.tmdb.movies.data.remote.api.MovieService;
import com.embibe.tmdb.movies.data.remote.paging.MovieDataSourceFactory;
...
public class MoviesRemoteDataSource {
    ...
    public RepoMoviesResult loadMoviesFilteredBy(MoviesFilterType sortBy) {
        MovieDataSourceFactory sourceFactory =
                new MovieDataSourceFactory(mMovieService, mExecutors.networkIO(), sortBy, null);
    ...
    public RepoMoviesResult loadMoviesSearchBy(String searchBy) {
        MovieDataSourceFactory sourceFactory =
                new MovieDataSourceFactory(mMovieService, mExecutors.networkIO(), null, searchBy);
