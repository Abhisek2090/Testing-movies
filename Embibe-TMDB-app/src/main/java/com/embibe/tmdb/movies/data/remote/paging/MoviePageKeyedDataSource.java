...
import com.embibe.tmdb.movies.data.local.model.MoviesResponse;
...
//        }
        ...
        if(searchBy != null) {
            request = movieService.searchMovies(searchBy, FIRST_PAGE);
        }
...
//        }
        ...
        if(searchBy != null) {
            request = movieService.searchMovies(searchBy, params.key);
        }
